(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["HcRoadResurfacings"] = factory(require("vue"));
	else
		root["HcRoadResurfacings"] = factory(root["Vue"]);
...
__webpack_require__.d(modules_namespaceObject, "resurfacings", function() { return resurfacings; });
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"553e40dc-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=40bc3870&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[(_vm.loading)?_c('div',{staticClass:"text-center h2"},[_vm._v("\n    Loading...\n    "),_c('i',{staticClass:"fas fa-spinner fa-pulse"})]):_vm._e(),_c('ResurfacingsTable',{directives:[{name:"show",rawName:"v-show",value:(!_vm.loading),expression:"!loading"}]})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=40bc3870&
...
/* harmony default export */ var esri = ({
  getters: {
    resurfacingsFeatureLayer: function resurfacingsFeatureLayer() {
...
// CONCATENATED MODULE: ./src/store/Resurfacing.js


var Resurfacing_Resurfacing = function Resurfacing(feature) {
  _classCallCheck(this, Resurfacing);
...
// CONCATENATED MODULE: ./src/store/modules/resurfacings.js

/* harmony default export */ var resurfacings = ({
  state: {
    index: []
  },
  actions: {
    fetchResurfacings: function fetchResurfacings(_ref) {
      var commit = _ref.commit,
          getters = _ref.getters;
      commit('setLoading');
      getters.resurfacingsFeatureLayer.then(function (fl) {
        fl.queryFeatures(getters.queryParams).then(function (response) {
          commit('setResurfacings', response.features.map(function (x) {
            return new Resurfacing_Resurfacing(x);
          }));
        }).catch(function (err) {
  ...
  mutations: {
    setResurfacings: function setResurfacings(state, data) {
      state.index = data;
    }
  }
});
...
/* harmony default export */ var Tablevue_type_script_lang_js_ = ({
  mounted: function mounted() {
    this.fetchResurfacings();
  },
  methods: mapActions(['fetchResurfacings']),
  computed: mapState({
    resurfacings: function resurfacings(state) {
      return state.resurfacings.index;
    }
  })
});
...
//# sourceMappingURL=HcRoadResurfacings.umd.js.map